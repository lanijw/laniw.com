...
function generateProjectModules() {
  ...
  const starterProjectModules = starterProjects.map((n, i) => generateModule(n,
    6,
    starterProjects.slice(0, i)))
  const finalProject = generateModule("pro6I",
    12,
    ["pro1I", "pro2I", "pro3I", "pro4I", "pro5I"])
...
function generateEnglModules() {
  const englModules = [
    "den1", "den2", "ten1", "ten2", "edse", "engw", "ewr", "eidpe", "ehsw",
    "erctc", "etc1", "ecpe", "ecpe1", "ecpe2", "ecae", "ecae1", "ecae2", "eadc",
    "eace", "ecura", "ecro", "ebec1", "ebec2", "esfss", "egi", "eprco", "efst",
    "edc", "ells", "ekn", "ekn2", "emm", "edd", "etmm"
  ]
...
function generateGswModules() {
  const cultureHistoryModules = [
    "apgz", "awrp", "chgw", "ents", "etm", "gswbb", "incaw", "inder", "infge",
    "jkg", "koge", "moke", "mgfg", "nmo", "oekg", "rgf", "sapp", "scc", "teph",
    "umb", "wccw", "wusa", "rukg", "mbb", "lwl", "krko", "phil", "veth", "teg"
  ]
  const societyEconomyRights = [
    "apsy", "arwk", "cemB", "fhrg", "infg", "infre", "kmgt", "opd", "patr",
    "psych", "rweENG", "sisop", "soz", "ter", "topsiB", "wiwaB", "imchB",
    "lean", "gef"
  ]
  const ethicsEcologySustainabilityModules = [
    "enstr", "krgw", "kufm", "oek", "sys", "tehab", "tet", "uwe", "ffup", "nww"
  ]
  return [
    ...cultureHistoryModules, ...societyEconomyRights,
...
export const allModules = [
  ...modules.projects.modules, ...modules.mainModules.baseModules.prog.modules,
